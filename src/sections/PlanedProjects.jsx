...
const PlanedProjects = ({ id, content }) => {
      ...
      <div className="flex flex-col gap-3 sm:gap-4 items-center justify-center pb-16 sm:pb-20 md:pb-24 lg:pb-32 bg-white w-full">
        ...
        <div className="w-full pt-8 sm:pt-10 md:pt-12 px-8 relative">
          ...
          <div className="flex items-center justify-end gap-3 mt-8 hidden md:flex">
            <div className="swiper-button-prev-custom w-12 h-12 bg-white border border-gray-200 rounded-full shadow-md flex items-center justify-center cursor-pointer hover:bg-gray-50 hover:scale-105 transition-all duration-200 group">
              <svg 
            ...
            <div className="swiper-button-next-custom w-12 h-12 bg-white border border-gray-200 rounded-full shadow-md flex items-center justify-center cursor-pointer hover:bg-gray-50 hover:scale-105 transition-all duration-200 group">
              <svg 
                className="w-5 h-5 text-dark-text group-hover:text-black transition-colors" 
                fill="none" 
                stroke="currentColor" 
